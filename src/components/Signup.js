                  ...
                  <div className="col-md-6 col-lg-7 d-flex align-items-center">
                    <div className="card-body p-4 p-lg-5 text-black">
                      <form>
                        ...
                        <p className='h4 fw-normal'>Create an Account!</p>
                        </div>
                        <div className='d-flex align-items-center justify-content-center mb-3'>
                            <span className='text-uppercase'><a className='text-decoration-none text-secondary' href="#!">or sign up with email</a></span>
                        </div>
                        <div className="form-outline mb-4">
                          <label className="form-label" htmlFor="form2Example17">Username</label>
                          <input type="username" id="form2Example17" className="form-control form-control-lg bg-light" />
                        </div>
                        <div className="form-outline mb-4">
                          <label className="form-label" htmlFor="form2Example17">Email address</label>
                          <input type="email" id="form2Example18" className="form-control form-control-lg bg-light" />
                        </div>
                        <div className="form-outline mb-4">
                        ...
                        <div className="pt-1 mb-4">
                            <div className="d-grid gap-2">
                                <button className="btn btn-secondary btn-lg" type="button">Create Account</button>
                            </div>
                        </div>
